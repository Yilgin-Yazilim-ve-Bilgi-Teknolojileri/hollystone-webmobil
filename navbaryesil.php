<nav class="nav2 discmanbg">
    ...
    <div>
        ...
        <div class="baslikkons">
            <span class="bas"><strong>YAKLAŞAN</strong> KONSERLER</span>
        </div>
        <div class="slider-container">
            <div class="slider">
                <div class="slide">

                    <div class="concardkons">
            ...
            <div style="display: flex;justify-content:center;margin-top:50px;">
                <div class="prev-arrow2">
                    <svg style="width: 100%;height:100%;padding:10px;" width="19" height="25" viewBox="0 0 19 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 12.5L18.5 1L10.5 9.5L8 12L6 12.5L8 13L10.5 15.5L13 18L18.5 24L1 12.5Z" fill="#303030" stroke="#303030" />
                    </svg>
                </div>
                <div style="display: contents;" class="dots">
                </div>

                <div class="next-arrow2">
                    <svg style="width: 100%;height:100%;padding:10px;" width="20" height="25" viewBox="0 0 20 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.5 12.5L1 24L9 15.5L11.5 13L13.5 12.5L11.5 12L9 9.5L6.5 7L1 1L18.5 12.5Z" fill="#303030" stroke="#303030" />
                    </svg>
                </div>
            </div>
        </div>
...
<script>
    ...
    const prevArrow = document.querySelector('.prev-arrow2');
    const nextArrow = document.querySelector('.next-arrow2');
    const dotContainer = document.querySelector('.dots'); // Noktaların yerleştirileceği konteyner
